...
class EP_Emailplatform_AccountController extends Mage_Customer_AccountController
{
        ...
        try {
            ...
            if ($customer->getConfirmation()) {
                ...
                try {
                    ...
                    if ($subscriber->isSubscribed() && Mage::getStoreConfig('emailplatform/general/active')) {
                        Mage::getSingleton('emailplatform/mailplatform')->subscribe($customer);
                    }
                } catch (Exception $e) {
